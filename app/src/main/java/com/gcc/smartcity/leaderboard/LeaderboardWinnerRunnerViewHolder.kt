...
class LeaderboardWinnerRunnerViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    private val leaderboardFirstUserPointsEarned =
        view.layout_winner_leaderboardFirstUserPointsEarned
    ...
    private val leaderboardSecondUserPointsEarned =
        view.layout_winner_leaderboardSecondUserPointsEarned
    ...
    private val leaderboardThirdUserPointsEarned =
        view.layout_winner_leaderboardThirdUserPointsEarned
